# Faculdade EAD Live em Análise e Desenvolvimento de Sistemas: Full Stack e Automação

## Diploma em Análise e Desenvolvimento de Sistemas, com ênfase em Full Stack e Automação

Aprenda a criar aplicações completas — do front-end ao back-end — que sustentam produtos digitais, plataformas e serviços online. Esta graduação prepara você para atuar em projetos modernos de desenvolvimento full stack, com automações e recursos de IA como um diferencial que moderniza sistemas, otimiza processos e amplia o impacto do seu trabalho no mercado.
...
* Analisar o desempenho de algoritmos de ordenação utilizando Phyton e recursos Linux
* Desenvolver programas utilizando computação paralela, manipulação de dados em árvore e busca de rotas de rede
